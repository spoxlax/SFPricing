...
export default function AddProductModal({ onSave, onClose, profileName }: AddProductModalProps) {
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {profileName && (
              <p className="text-sm text-gray-600 mt-1">Adding to profile: <span className="font-medium">{profileName}</span></p>
            )}
          </div>
          <button
            onClick={onClose}
